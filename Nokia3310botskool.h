// NOkia 3310 LCD Controller PCD8544 LIBARARY
// Original Author Michel Bavin
// Modified to work with MikroC
// Reference: https://web.archive.org/web/20120825073422/http://www.botskool.com/downloads/electronics/nokia3310/Nokia3310botskool.h
...
#include "all.h"
//===================
#define nok_sclk  portB.f3
#define nok_sda   portB.f2
#define nok_dc    portC.f6
#define nok_cs    portC.f7
